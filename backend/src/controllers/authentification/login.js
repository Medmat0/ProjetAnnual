  ...
  if (!user.emailVerified) {
    ...
    const info = {
      ...
      htm: `<h1>Email verfication </h1>
          <p>Hello ${user.name}, Please follow this link to verfiy your account. </p><a href= 'https://sharecode-front.azurewebsites.net/verfiy/${plainVerfiyToken}'> Click link </a>
